	...
	<view class="content">
		<view id="title">
			<view class="cu-bar  solid-bottom">
				<view class="action ">
					<text class="cuIcon-friendfill text-blue"></text><text class="title">企业管理系统说明</text> 
				</view>
			</view>
		</view>
		...
		<view id="connect" class="margin-top-xs">
			...
			<rich-text>（开发者）微信：<text style="font-size: 36upx;color:orange;">ljw39944254</text></rich-text>
		</view>
	</view>
</template>
